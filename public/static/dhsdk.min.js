...
DHAlarmWeb.prototype.processAlarmMessage = function (e) {
    ...
    try {
                ...
                this.keepAliveInterval = setInterval(function () {
                    var e = {
                        ...
                        msg: JSON.stringify({
                            ...
                            params: {loginHandle: i.params.loginHandle}
                        })
                    };
                ...
                this.deviceListTimer = setTimeout(function () {
                    if (!this.hasDeviceList) {
                        var e = {
                            clientid: "",
                            error: "fail",
                            msg: {method: "systemManager.onError", error: "dataTimeout"}
                        };
                        if (this.onDHAlarmWebError) {
        ...
        } else if (i.method == "configManager.onDeviceMove") {
...
DHAlarmWeb.prototype.sendAudio = function (e) {
    ...
    navigator.mediaDevices.getUserMedia({audio: true}).then(function (e) {
        ...
        this.recorder.onaudioprocess = function (e) {
                ...
                while (r < n) {
                    ...
                    if (s < 320) {
                        ...
                        if (this.broadcastType == 1 && this.talkDeviceIds.length == 0) {
                            ...
                            for (let e in p.sendIds) {
                                var v = p.sendIds[e];
                                if (p.audioWs[v] && p.audioWs[v].readyState == p.audioWs[v].OPEN) {
                                    p.audioWs[v].send(g)
                                }
                                if (p.onLocalAudioData) {
                                    p.onLocalAudioData(m, v)
                                }
                            }
                        }
                        i = new DataView(t);
            ...
            var f = new OfflineAudioContext(1, parseInt(this.recorder.bufferSize * 16e3 / this.context.sampleRate), 16e3);
            var p = f.createBufferSource();
            p.buffer = l;
            p.connect(f.destination);
            p.start();
            f.startRendering().then(function (e) {
...
DHAlarmWeb.prototype.startMultiMicTalk = function (e, t) {
    ...
    for (let n in t) {
        ...
        var a = {
            ...
            params: {deviceId: parseInt(i), loginHandle: parseInt(e), preview: false}
        };
        var r = {cmd: "send", msg: JSON.stringify(a)};
        if (s == -1) {
...
DHAlarmWeb.prototype.startMultiFileTalk = function (e, t, i) {
    ...
    for (let i in t) {
        ...
        var r = {
            method: "deviceManager.playRT",
            params: {deviceId: parseInt(s), loginHandle: parseInt(e), preview: false}
        };
    ...
    o.onload = function () {
        ...
        e.decodeAudioData(o, function (e) {
            ...
            o.startRendering().then(function (e) {
                ...
                while (r < n) {
                    ...
                    if (s < 320) {
                        ...
                        var f = t.slice(0, 320);
                        var p = new Int16Array(f);
                        h.push(p);
                        l.bufferFileArr_8k.push(p);
                        i = new DataView(t);
                        s = 0;
                        i.setInt16(s, c, true)
                    }
            ...
            u.startRendering().then(function (e) {
                ...
                while (i < s) {
                    ...
                    if (n < 640) {
                        ...
                        var u = a.slice(0, 640);
                        var p = new Int16Array(u);
                        f.push(p);
                        l.bufferFileArr_16k.push(p);
                        r = new DataView(a);
                        n = 0;
                        r.setInt16(n, h, true)
                    }
            ...
            var t = {
                clientid: "",
                error: "fail",
                msg: {method: "systemManager.onError", error: "decodeError", errorMsg: e}
            };
            ...
            l.startRendering().then(function (s) {
                ...
                var v = {
                    ...
                    params: {
                        ...
                        file: {
                            name: i,
                            length: n.totalUploadFileArr.length * 640,
                            sampleRate: 16e3,
                            bitsPerSec: 128,
                            encode: "pcm"
                        }
...
DHAlarmWeb.prototype.uploadBCTask = function (e, t, i, s, a, r, n, o, l, d, h, u, c, f = "timed", p = "file") {
    var m = {}, g = {}, v = {};
    if (h && h.enable) {
        m.enable = h.enable;
...
DHAlarmWeb.prototype.editBCTask = function (e, t, i, s, a, r, n, o, l, d, h, u, c, f, p = "timed", m = "file") {
    var g = {}, v = {}, A = {};
    if (u && u.enable) {
        g.enable = u.enable;
    ...
    var D = {cmd: "send", msg: JSON.stringify(y)};
    this.sendAlarmMessage(D)
};
...
DHAlarmWeb.prototype.configPayStatus = function (e, t, i, s, a, r, n, o, l, d, h, u) {
    ...
    var p = {
        ...
        params: {loginHandle: parseInt(t), deviceId: parseInt(i), tunnelData: JSON.stringify(f)}
    };
    var m = {cmd: "send", msg: JSON.stringify(p)};
